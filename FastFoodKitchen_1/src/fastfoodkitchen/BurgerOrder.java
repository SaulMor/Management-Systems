...
public class BurgerOrder {
    ...
    public BurgerOrder(int numHamburgers, int numCheeseburgers, int numVeggieburgers, int numSodas, boolean orderToGo, int orderNum) {
        if (numHamburgers < 0) {
            throw new IllegalArgumentException("Number of hamburgers must be 0 or more.");
        }
        if (numCheeseburgers < 0) {
            throw new IllegalArgumentException("Number of cheeseburgers must be 0 or more.");
        }
        if (numVeggieburgers < 0) {
            throw new IllegalArgumentException("Number of veggieburgers must be 0 or more.");
        }
        if (numSodas < 0) {
            throw new IllegalArgumentException("Number of sodas must be 0 or more.");
        }
    ...
    /**
     * Returns a string representation of the BurgerOrder object, including the
     * number of hamburgers, cheeseburgers, veggieburgers, sodas, whether the
     * order is to go, and the order number.
     *
     * @return a string representation of the BurgerOrder object
     */
    @Override
    ...
    /**
     * Checks whether the order is completed.
     *
     ...
     *
     * @param completed the new completion status to set for the order
     */
    ...
    /**
     * Checks whether the order is canceled.
     *
    ...
    /**
     * Sets the cancellation status of the order.
     *
     * @param canceled the new cancellation status to set for the order
     */
    public void setCanceled(boolean canceled) {
        this.canceled = canceled;
    }

} //End BurgerOrder class
